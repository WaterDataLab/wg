...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar: 
      - { icon: "fa-download", href: "https://github.com/WaterDataLab/wg/raw/main/content/gsa-84/gsa-84.zip", target: "_blank", align: "left", padding: "200px" }
params: 
  AOI: "000"
---
...
gwl_gsa <- filter(gwl, GSA_ID == params$AOI)
